...
wget -q -O /usr/bin/renew "https://raw.githubusercontent.com/casper9/tarap/main/ssh/renew.sh" && chmod +x /usr/bin/add-host
...
wget -q -O /usr/bin/speedtest "https://raw.githubusercontent.com/sivel/speedtest-cli/master/speedtest.py" && chmod +x /usr/bin/speedtest
