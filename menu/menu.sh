...
###########- COLOR CODE -##############
colornow=$(cat /etc/casper9/permission/main/ipmini/color.conf)
export NC="\e[0m"
export YELLOW='\033[0;33m';
export RED="\033[0;31m"
export COLOR1="$(cat /etc/casper9/permission/main/ipmini/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
export COLBG1="$(cat /etc/casper9/permission/main/ipmini/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"
WH='\033[1;37m'
###########- END COLOR CODE -##########
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/casper9/tarap/main/menu/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
...
echo -e "$COLOR1 ${NC}             ${WH}• TELE : https/t.me/CasperGaming •${NC}             $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
